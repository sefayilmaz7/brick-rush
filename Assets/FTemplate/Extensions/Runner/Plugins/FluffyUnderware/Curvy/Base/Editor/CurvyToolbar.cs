...
namespace FluffyUnderware.CurvyEditor.UI
{
    ...
    */
    ...
    public class TBSplineSetPivot : DTToolbarToggleButton
    {
        ...
        float pivotY;
        float pivotZ;
        private List<CurvySpline> selectedSplines = new List<CurvySpline>();

        public override void OnSelectionChange()
        {
            Visible = DTSelection.HasComponent<CurvySpline>(true);
            selectedSplines = DTSelection.GetAllAs<CurvySpline>();
        }
        ...
        public override void RenderClientArea(Rect r)
        {
            ...
            {
                is2D = true;
                foreach (CurvySpline spline in selectedSplines)
