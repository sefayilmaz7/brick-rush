...
namespace MoreMountains.NiceVibrations
{
	...
	public static class MMVibrationManager
	{
        ...
        private const string VIBRATION_ENABLED_KEY = "Vibration";
        ...
        public static bool VibrationEnabled
        {
            get
            {
                if( !vibrationEnabled.HasValue )
                {
                    vibrationEnabled = PlayerPrefs.GetInt( VIBRATION_ENABLED_KEY, 1 ) == 1;
                    if( vibrationEnabled.Value != _vibrationsActive )
                        _vibrationsActive = vibrationEnabled.Value;
                }
            ...
            set
            {
                ...
                _vibrationsActive = value;

                PlayerPrefs.SetInt( VIBRATION_ENABLED_KEY, value ? 1 : 0 );
                PlayerPrefs.Save();
            }
        }
